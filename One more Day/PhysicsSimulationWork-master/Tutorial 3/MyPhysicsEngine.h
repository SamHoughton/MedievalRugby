...
//			pairFlags |= PxPairFlag::eNOTIFY_CONTACT_POINTS;
	...
	public:
		...
		virtual void CustomInit() 
		{
			...
			hiddenbox = new HiddenBox(PxTransform(PxVec3(24.f, 20.f, 0.f), PxQuat(PxPiDivTwo, PxVec3(0.f, 1.f, 0.f))));
			...
			for (int a = 10; a < 20; a = a + 1) {
				...
				horse = new Horse(PxTransform(PxVec3(RandX, 1.f, RandY)));
				Add(horse);
				...
				if (horseActor->isRigidBody())
				{
					...
					horseBody->addForce(PxVec3(RandY, 0.0f, 5.f), PxForceMode::eACCELERATION, 1);
				}
			}
